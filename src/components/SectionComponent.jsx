  ...
  return (
    <button className={props.className} onClick={props.onClick}>
      <div className="flex justify-start items-center">
        <span className="font-bold text-white text-lg pl-4 lg:pl-2">
          {props.text}
        </span>
      </div>
      <svg className="absolute w-36 h-36 opacity-20 -top-14 right-56 lg:right-36">
        <circle cx="50" cy="50" r="50" stroke="white" fill="white" />
      </svg>
      <svg
        className="absolute w-36 h-36 -top-8 left-52 md:left-60 lg:left-32 -z-1 opacity-20"
